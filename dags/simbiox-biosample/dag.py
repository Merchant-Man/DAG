...
def transform_data(df: pd.DataFrame, ts: str) -> pd.DataFrame:
    ...
    df.rename(columns={"patient_id": "id_patient","repository_code": "code_repository",
    "box_code": "code_box","position_code": "code_position",
    "received_date": "date_received","enter_date_in_biorepo": "date_enumerated",
    "id_biobank": "origin_biobank","sample_old_code":"origin_code_repository",
    ...
    "status": "biosample_status"}, inplace=True)
    ...
    df = df[["id_patient", "code_repository", "code_box", "code_position", "date_received", "date_enumerated", "origin_biobank", "origin_code_repository", "origin_code_box", "biosample_type", "biosample_specimen", "type_case", "sub_cell_specimen",  "biosample_volume", "biosample_status", "created_at", "updated_at"]]
