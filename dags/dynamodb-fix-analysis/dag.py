...
from utils.dynamodb_fix import fetch_dynamodb_and_load_to_s3, transform_fix_analysis_data
...
DYNAMODB_TABLE = Variable.get("DYNAMODB_TABLE_FIX_ANALYSIS")
LOADER_QUERY = "dynamodb_fix_analysis_loader.sql"
FIX_OBJECT_PATH = "dynamodb/fix/analysis"
...
silver_fix_analysis_transform_to_db_task = PythonOperator(
    task_id="silver_fix_analysis_transform_to_db",
...
fetch_transform_and_load_task >> silver_fix_analysis_transform_to_db_task 
