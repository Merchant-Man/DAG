...
INSERT INTO illumina_appsessions (row_type,session_id,session_name,date_created,date_modified,execution_status,ica_link,ica_project_id,workflow_reference,run_id,run_name,percent_gt_q30,flowcell_barcode,reagent_barcode,`status`,experiment_name,run_date_created,biosaample_name,biosample_id,computed_yield_bp,generated_sample_id,created_at,updated_at) VALUES (
...
biosaample_name=VALUES(biosaample_name),
biosample_id=VALUES(biosample_id),
computed_yield_bp=VALUES(computed_yield_bp),
