...
(SELECT
	...
	id_mpi,
	id_subject,
	# Taking from patient for valid biobank origin
	sp2.biobank_nama
FROM
	(
		...
		WHERE
			sb.id_biobank NOT IN('1', '80dc7749-63f2-4a3a-9486-562f8a677333') #  exclude ('Biobank Sentral (BB Binomika)', 'Biobank Pusat')
		GROUP BY
			id_patient,
			code_repository
	) sb
