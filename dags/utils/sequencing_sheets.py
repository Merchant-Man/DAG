...
def dump_sequencing_sheets_to_s3_and_db(aws_conn_id: str, bucket_name: str,
    ...
    with engine.begin() as conn:
        df.to_sql(
                ...
                con=conn,
                dtype={'code_repository': VARCHAR(16), 'platform': VARCHAR(8), 'extraction_status': VARCHAR(32), 'libprep_status': VARCHAR(32), 'sequencing_finish_date': DATETIME, 'sequencing_status': VARCHAR(8)}
            )
