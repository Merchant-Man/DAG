...
prefix="simbiox/patients/"
bronze_prefix="simbiox/tbl_data_patients/"
...
def fetch_data(**kwargs):
    ...
    files = s3.list_keys(bucket_name=S3_DWH_BRONZE, prefix=bronze_prefix)
    
    if not files:
        raise ValueError(f"No files found in {bronze_prefix}")
